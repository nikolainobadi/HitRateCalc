...
SVC_NAME="actions.runner.nikolainobadi-HitRateCalc.Nikolais-Mac-Studio"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (nikolainobadi-HitRateCalc.Nikolais-Mac-Studio)"
